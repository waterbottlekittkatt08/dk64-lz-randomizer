...
function displaySeedSpoiler()
	print("");
	print("~~~~~~~~~~~~~");
	print("SEED SPOILERS");
	print("Seed Number: "..seedAsNumber);
	print("");
	print("REGULAR MAP ASSORTMENT");
	for i = 1, #regular_map_assortment do
		...
		print("");
		print("LZ to: "..maps[lz_map_in + 1].." (Exit "..lz_exit_in..")");
		print("Goes to: "..maps[lz_map_out + 1].." (Exit "..lz_exit_out..")");
	end
	print("");
	print("BONUS MAP ASSORTMENT");
	for i = 1, #bonus_map_assortment do
		lz_map_in = bonus_map_table[i];
		lz_map_out = bonus_map_table[bonus_map_assortment[i]];
		print("");
		print("LZ to: "..maps[lz_map_in + 1]);
		print("Goes to: "..maps[lz_map_out + 1]);
	end
	print("");
	print("BOSS MAP ASSORTMENT");
