KasplatLocations = {
	[0] = { -- Japes
	--  [number] = {map, {x, y, z}, chunk, spoilerName, xmin, xmax, zmin, zmax},
		[1] = {7, {870, 280, 3578}, 12, "Behind Rambi Wall", 740, 990, 3500, 3700},-- Behind Rambi Wall
		[2] = {7, {1592, 989, 2443}, 3, "On top of mountain", 1570, 1650, 2380, 2490},-- On top of mountain
		[3] = {7, {2270, 552, 3153}, 7, "Beehive Area", 2180, 2450, 3050, 3280},-- Beehive Area
		...
		[9] = {7, {1333, 280 ,1938}, 3, "Inside Tiny's Cage", 1320, 1360, 1910, 1960}, -- Tiny Cage GB
		[10] = {7, {899, 280, 640}, 0, "Starting Area", 800, 1100, 460, 800}, -- First Area
		[11] = {7, {2461, 280, 548}, 2, "Diddy Cave", 2370, 2620, 350, 650}, -- Diddy Cave
		[12] = {7, {1569, 160, 1844}, 3, "In the river", 1470, 1750, 1650, 2100}, -- In the river
		[13] = {7, {382, 140, 2818}, 13, "In the water near Rambi Wall", 360, 500, 2700, 2900}, -- In the water at the fairy
		[14] = {7, {1675, 280, 4197}, 14, "Near Cranky's", 1420, 1950, 4050, 4350}, -- Cranky Area
		[15] = {7, {773, 538, 2320}, 3, "In the T&S Alcove", 720, 800, 2295, 2380}, -- In the T&S alcove (with the DK bunch)
	},
	[1] = { -- Aztec
		[1] = {38, {2738, 120, 4763}, 11, "In the Stealthy Snoop Tunnel", 2640, 2825, 4650, 4850},-- In Stealthy Snoop Tunnel
		[2] = {38, {2467, 116, 990}, 4, "On the Oasis", 2350, 2500, 880, 1050},-- Oasis
		[3] = {38, {2129, 312, 1551}, 4, "On the Llama's Cage", 2110, 2155, 1525, 1590},-- On Llama Cage
		[4] = {38, {3782, 120, 2391}, 8, "Near the giant boulder", 3660, 4060, 2310, 2510},-- Tunnel (near big boulder)
		...
		[8] = {38, {3301, 97, 3776}, 12, "Base of the Totem", 3275, 3308, 3768, 3790}, -- Base of Totem
		[9] = {38, {280, 138, 716}, 1, "In the Vase Room", 300, 420, 650, 750}, -- in the Chunky vase room
		[10] = {38, {1997, 280, 3500}, 12, "Behind the 5-Door Temple", 1970, 2020, 3470, 3520}, -- alcove in the back of 5DT
		[11] = {38, {3969, 190, 4037}, 12, "Near Snide's", 3930, 4020, 3990, 4080}, -- near Snide's
		[12] = {20, {1964, 472, 2408}, 0, "Below the Llama in Llama Temple", 1860, 2010, 2360, 2440}, -- In Llama temple, next to the llama (down)
		[13] = {16, {453, 345, 1465}, 4, "In the Free Tiny Room", 140, 720, 1200, 1700}, -- OKONG Room
	},
	[2] = { -- Factory
		[1] = {26, {1591, 1113, 615}, 18, "Near Funky's", 1570, 1680, 580, 800},-- By Funky's
		[2] = {26, {1712, 837, 2389}, 12, "Starting Area", 1680, 1740, 2300, 2440},-- Lobby
		[3] = {26, {1464, 127, 865}, 0, "Near the Power Hut", 1400, 1540, 840, 920},-- Power Hut Platform
		[4] = {26, {646, 460, 1792}, 7, "Down the pole covered by a Hatch", 600, 700, 1740, 1820},-- Middle Floor of Hatch Pole
		[5] = {26, {2053, 7, 573}, 1, "In the Dark Room", 2000, 2100, 500, 850},-- Dark Room
		[6] = {26, {633, 157, 1672}, 5, "On the lowest platform in Production Room", 550, 730, 1645, 1705},-- Lowest platform of Prod Room
		...
		[12] = {26, {621, 440, 1335}, 7, "Inside the central Crusher in Production Room", 600, 650, 1310, 1360},-- Inside the Crusher
		[13] = {26, {1276, 201, 710}, 0, "On Chunky's Cage", 1130, 1540, 530, 900}, -- On Chunky's Cage
		[14] = {26, {1579, 811, 2197}, 10, "Near Snide's", 1510, 1660, 2120, 2240}, -- Snide's
		--[15] = {26, {2664, 1034, 1834}, 8, "On the 1-16 Number Game"},-- Number game
	},
	[3] = { -- Galleon
		[1] = {30, {3468, 1670, 3803}, 8, "Near the 3 Above-Ground treasure Chests", 3340, 3500, 3715, 3900},-- Chest area
		[2] = {30, {1631, 1611, 4162}, 9, "On the Lighthouse island", 1625, 1670, 4100, 4185},-- Lighthouse Platform
		[3] = {30, {3596, 1614, 1899}, 13, "Near Warp 5 on the 5-Door Ship Side", 3570, 3620, 1870, 1920},-- Floating Platform
		...
		[9] = {30, {3307, 1680, 2451}, 7, "On the Crown Pad", 3240, 3360, 2370, 2500}, -- Crown
		[10] = {30, {1249, 1451, 2876}, 5, "In the water in Cannon Game Room", 1160, 1300, 2700, 3000}, -- In the cannon room water
		[11] = {30, {3314, 1792, 2498}, 7, "Next to Cranky's", 3260, 3370, 2440, 2540}, -- on Cranky's platform
	...
	[4] = { -- Fungi
		[1] = {48, {4672, 153, 4130}, 2, "By the tag barrel near the exit to the Minecart", 4640, 4830, 4100, 4300},-- New Rainbow Coin
		[2] = {48, {3150, 273, 4332}, 4, "Behind the Diddy Dark Barn", 3100, 3200, 4330, 4420},-- Behind Diddy Barn
		[3] = {48, {1853, 230, 473}, 9, "Behind the beanstalk", 1780, 1890, 380, 780},-- Beanstalk
		[4] = {48, {183, 241, 756}, 11, "Near the rocketbarrel near the Giant Mushroom", 100, 380, 650, 940},-- Near GM Rocketbarrel
		[5] = {48, {850, 1250, 550}, 11, "At the top of the Giant Mushroom", 770, 1060, 530, 580},-- GM High Tag
		[6] = {48, {1250, 270, 4400}, 16, "Near the Anthill", 1170, 1390, 4220, 4575},-- Near Anthill
		[7] = {48, {2335, 143, 3639}, 15, "Near the sleeping Rabbit", 2150, 2450, 3540, 3730},-- Near Rabbit Race
		[8] = {48, {543, 194, 3748}, 17, "Near the T&S near the Owl's Tree", 320, 850, 3600, 4080},-- Near Tree T&S
		...
		[14] = {48, {2297, 604, 2318}, 0, "Behind the Cuckoo Clock", 2275, 2350, 2250, 2400}, -- Clock
		[15] = {61, {360, 0, 450}, 0, "Inside the mill", 200, 600, 360, 500}, -- Mill
		[16] = {48, {1009, 100, 576}, 11, "In the moat around the Giant Mushroom", 740, 1120, 540, 630}, -- Moat (GM Exterior)
	},
	[5] = { -- Caves
		[1] = {72, {2594, 14, 434}, 0, "In the room near the start", 2520, 2650, 370, 600},-- GGone Room
		[2] = {72, {1242, 65, 585}, 2, "Near Snide's", 1160, 1340, 500, 640},-- Snide's Room
		[3] = {72, {523, 181, 2498}, 6, "In the room with Tiny's Bonus Barrel", 360, 550, 2350, 2600},-- W3 Room
		[4] = {72, {752, 53, 778}, 8, "Inside an Ice Shield", 720, 800, 750, 830},-- Inside Chunky Ice Shield
		[5] = {72, {3645, 343, 1865}, 4, "On the Cabin with 5 Doors", 3590, 3650, 1580, 1880},-- 5DC Exterior
		[6] = {72, {2648, 173, 1770}, 4, "Near the headphones near Lanky's Cabin", 2550, 2830, 1730, 1860},-- Meme area near 1DC Headphones
		[7] = {72, {1915, 280, 2676}, 7, "In the room with the Giant Boulder", 1830, 2040, 2590, 2770},-- Giant Boulder Room
		...
		[13] = {72, {1340, 14, 2047}, 5, "In the water by the Baboon Blast Pad", 1240, 1490, 1920, 2170}, -- In the river near Pillar W4
		[14] = {72, {2434, 99, 1209}, 9, "Inbetween Funky's and the Ice Castle", 2260, 2500, 1130, 1240}, -- left side of river, near the edge where you jump across to climb to Funky's
	},
	[6] = { -- Castle
		[1] = {183, {439, 90, 1242}, 3, "In the Crypt, to the left", 340, 600, 1120, 1420},-- Crypt near D/D/C Entrance
		[2] = {183, {1839, 320, 1278}, 2, "In the Crypt, to the right", 1790, 1900, 1160, 1360},-- Crypt near L/T Entrance
		[3] = {163, {526, 195, 2013}, 1, "Inside the dungeon", 480, 600, 1400, 2570},-- Dungeon
		[4] = {87, {1655, 371, 2048}, 0, "Near the T&S at the back of Castle", 1600, 1720, 1970, 2090},-- Near exterior lower T&S
		[5] = {88, {547, 45, 613}, 2, "Inside the Ballroom", 340, 770, 330, 880},-- Ballroom
		[6] = {87, {1388, 1732, 1353}, 4, "At the top of the Castle", 1250, 1450, 1180, 1500},-- Top of Castle
	...
	[7] = { -- Isles
		...
		[2] = {34, {3557, 497, 1555}, 0, "On the Beaver Beach", 3410, 3740, 1460, 1950},-- Beaver Beach
		[3] = {175, {676, 134, 372}, 0, "Inside Factory Lobby, above the DK Portal", 640, 710, 330, 430},-- Factory Lobby (upper platform)
		[4] = {170, {335, 191, 637}, 0, "Inside Hideout Helm Lobby"},-- Helm Lobby
		[5] = {193, {577, 71, 766}, 0, "Inside Creepy Castle Lobby"},-- Castle Lobby
		[6] = {194, {1674, 13, 685}, 1, "Inside Crystal Caves Lobby"},-- Caves Lobby
		[7] = {175, {245, 81, 150}, 0, "Inside Factory Lobby, in the ? Box"},-- Factory Lobby (In ? Box)
		[8] = {174, {762, 119, 900}, 0, "Inside Gloomy Galleon Lobby"},-- Galleon Lobby
		[9] = {34, {4449, 552, 1673}, 0, "Inside the Rock which is blown up", 4260, 4560, 1520, 1780}, -- Big X Rock
		[10] = {34, {2357, 1199, 3903}, 1, "At the back of Kroc Isle, halfway up", 2320, 2440, 3855, 3910}, -- at the back of the W4 platform
		[11] = {34, {1578, 499, 457}, 0, "On the Big X Platform", 1475, 1685, 330, 565}, -- Big X
		[12] = {34, {2449, 1498, 785}, 0, "Behind the house to Fungi Lobby", 2430, 2480, 760, 800}, -- behind Fungi lobby
